export default {
  ...
  searchInformation: {
    ...
    totalResults: "581000000",
    formattedTotalResults: "581,000,000",
  },
  items: [
    {
    ...
    },
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSmCvd_AX4OPjIvAOxmTx9be9Bs5tzbcEpRsBFUt8NmYGDeIx3t_I5vIA",
            width: "150",
            height: "79",
          },
        ],
